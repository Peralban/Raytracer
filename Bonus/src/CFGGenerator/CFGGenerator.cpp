...
void Bonus::CFGGenerator::askShape()
{
    ...
    std::cout << "Enter the position of the shape: ";
    ...
    std::cout << "Enter the size of the shape: ";
    ...
    std::cout << "Enter the color of the material: ";
...
void Bonus::CFGGenerator::askCamera()
{
    ...
    std::cout << "Enter the position of the camera: ";
    std::cin >> view_from[X] >> view_from[Y] >> view_from[Z];
    ...
    std::cout << "Enter the point the camera is looking at: ";
    std::cin >> view_at[X] >> view_at[Y] >> view_at[Z];
    ...
    std::cout << "Enter the up vector of the camera: ";
    std::cin >> view_up[X] >> view_up[Y] >> view_up[Z];
    ...
    std::cout << "Enter the rotation of the camera: ";
...
Bonus::ParsingTransformation Bonus::CFGGenerator::askTransformation()
{
    ...
    std::cout << "Enter the type of the transformation: ";
    std::cin >> type;
    ...
    std::cout << "Enter the values of the transformation: ";
